  ...
  return (
    <Card className="w-auto h-fit">
      ...
      <CardDescription className="flex justify-center">
        <Card className="flex-col row-span-2 w-5/6 h-fit rounded-2xl text-w-3/4 overflow-x-auto py-5 bg-[url(/images/thismonthprofitreporttab.png)] bg-cover bg-center bg-no-repeat text-white">
          <Table>
            <TableBody>
      ...
      <CardDescription className="flex justify-center">
        <Card className="flex-col row-span-2 w-5/6 h-fit rounded-2xl text-w-3/4 overflow-x-auto py-5 bg-[url(/images/thismonthprofittab.png)] bg-cover bg-center bg-no-repeat text-white">
          <Table>
            <TableBody>
              <TableRow className="hover:bg-transparent border-y-transparent">
                <TableCell>
