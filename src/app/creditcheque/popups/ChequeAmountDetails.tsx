...
export default function ChequeAmountDetails() {
  return (
    <Card className="w-auto h-fit">
      ...
      <CardHeader className="py-1 whitespace-nowrap text-center text-xs font-medium">
        <CardTitle className="text-xl py-2">Cheque Amount Details</CardTitle>
      </CardHeader>
      <Table>
        <TableBody>
          <TableRow className="hover:bg-white">
      ...
      <Table>
        <TableBody>
          <TableRow className="hover:bg-white">
            <TableCell>
              <Label className="py-2" htmlFor="chequeno">
                Cheque No
              </Label>
              <Input id="chequeno" />
            </TableCell>
      ...
      <Table>
        <TableBody>
          <TableRow className="hover:bg-white">
            <TableCell>
              <Label className="py-2" htmlFor="chequeamount">
                Cheque Amount
              </Label>
              <Input id="chequeamount" />
            </TableCell>
          </TableRow>
        </TableBody>
      </Table>
        ...
        <TableBody>
          <TableRow className="hover:bg-white">
            <TableCell>
              ...
              <Select>
                <SelectTrigger id="action"></SelectTrigger>
                <SelectContent position="popper">
                  <SelectItem value="cashdone">Cash Done</SelectItem>
                  <SelectItem value="cashpending">Cash Pending</SelectItem>
